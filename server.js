...
const APP_VERSION = process.env.MINERADIO_VERSION || APP_PACKAGE.version || '2.3.1';
...
async function handleNeteaseAlbumDetail(id, limit) {
  ...
  return {
    ...
    album: {
      ...
      genre: info.genre || info.genres || [],
      tags: info.tags || [],
      language: info.language || '',
      description: String(info.description || info.briefDesc || '').slice(0, 6000),
...
async function handleQQAlbumDetail(mid, limit) {
  ...
  return {
    ...
    album: {
      ...
      tags: data.tags || [],
      language: data.lan || data.language || '',
      description: String(data.desc || data.description || '').slice(0, 6000),
